    ...
    <Container maxW="6xl" px={{ base: 6, md: 3 }} py={24}>
      <Stack direction={{ base: 'column', md: 'row' }} justifyContent="center">
        <Stack direction="column" spacing={6} justifyContent="center" maxW="480px">
          ...
          LEARN WITH  <br />
            <chakra.span color="teal">IFDA INSTITUTE</chakra.span>
          </chakra.h1>
          <Text
            fontSize="1.2rem"
            textAlign="left"
            ...
            color="gray.500"
          >
           Explore Boundless Horizons with IFDA Institute: Where Learning Paves the Way to Limitless Opportunities!
          </Text>
          <HStack
            spacing={{ base: 0, sm: 2 }}
          ...
          >
           <Link to="./courses">
            ...
            >
              ...
              <chakra.span> Explore Now </chakra.span>
              <Icon as={MdExplore } h={4} w={4} ml={1} />
